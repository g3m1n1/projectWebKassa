...
namespace projectWebKassa.Controllers
{
    public class AdresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdresId,Straat,PostCode,Land")] Adres adres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdresId,Straat,PostCode,Land")] Adres adres)
        {
            if (ModelState.IsValid)
            {
